...
Extract body text from:
  005 How to Universally Apply Buddhism in Daily Life.pdf
...
PDF_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Yin Shun/005 How to Universally Apply Buddhism in Daily Life.pdf"
OUT_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Yin Shun/005 How to Universally Apply Buddhism in Daily Life_clean.txt"
...
def merge_into_paragraphs(lines):
    """
    Join lines into paragraphs. Headings are short lines that start with a
    capital letter and don't end with a period (not mid-sentence line breaks).
    """
    paragraphs = []
    current = []
    for line in lines:
