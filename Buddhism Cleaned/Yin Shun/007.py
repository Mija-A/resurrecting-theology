...
PDF_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Yin Shun/007 Recollecting Buddhas, Being Vegetarian, Reciting Sūtras.pdf"
OUTPUT_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Yin Shun/007_Recollecting_Buddhas_clean.txt"

START_PDF_PAGE = 2

SKIP_LINES = {
    "recollecting buddhas, being vegetarian, reciting sūtras",
    "recollecting buddhas, being vegetarian, reciting sutras",
}

# Footnote block opener: digit(s) followed by space, Chinese char, or bracket
FOOTNOTE_BLOCK_RE = re.compile(r'^\d{1,2}[\s\u300a\u300b《》「」（）]')

# Inline superscript markers e.g. "buddhas,8 which" -> "buddhas, which"
...
def clean_page(text):
    ...
    while i < len(lines):
        ...
        # separator line triggers footnote mode
        if re.fullmatch(r'[_\-─—]{3,}', s):
            in_footnote = True
            i += 1
            continue

        # footnote block opener
        ...
        if in_footnote:
            # exit only for clear English body text
        ...
        # strip inline superscript footnote markers
