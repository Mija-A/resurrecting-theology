...
PDF_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Tsongkhapa/Splendor-of-an-Autumn-Moon-pp82-95.pdf"
OUTPUT_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/Tsongkhapa/Splendor-of-an-Autumn-Moon-pp82-95_clean.txt"

START_PAGE = 2

SKIP_LINES = {
    "splendor of an autumn moon",
...
def clean_text(text):
    ...
    for page in pages:
        ...
        while i < len(lines):
            ...
            # skip standalone arabic page numbers
