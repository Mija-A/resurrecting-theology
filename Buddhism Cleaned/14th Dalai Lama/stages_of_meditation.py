...
PDF_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/14th Dalai Lama/Dalai Lama_Stages-of-Meditation.pdf"
OUTPUT_PATH = "/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Buddhism Cleaned/14th Dalai Lama/Dalai Lama_Stages-of-Meditation_clean.txt"
...
def clean_half(text):
    ...
    text = re.sub(r'\bche\b', 'the', text)
    text = re.sub(r'\bcurn\b', 'turn', text)
    text = re.sub(r'\bchought\b', 'thought', text)
    ...
    while i < len(lines):
        ...
        # strip trailing pipes and stray dots
...
def main():
    ...
    for i, img in enumerate(images):
        ...
        print(f"  PDF page {pdf_page_num} done", flush=True)
    ...
    print(f"\nDone -> {len(blocks)} blocks written to:\n  {OUTPUT_PATH}")
