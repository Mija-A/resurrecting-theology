...
GENERATION_MODEL_NAME = "glm-4-9b-chat"
TOP_K = 8
...
def extract_number(text: str):
    ...
    # Cap out-of-range values — anything above 10 is a hallucinated number
    # (max valid WVS scale is 10), not a valid survey response
    if value > 10:
        return -99
...
def build_prompt(religion: str, scholar: str, question: str, coding: str) -> str:
    return (
        ...
        f"Question:\n{question}\n\n"
        f"Response coding:\n{coding}\n\nRespond with ONLY the number. No words, no punctuation, just the integer."
    )
