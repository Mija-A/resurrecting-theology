...
PDF_PATH = Path("/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Nisargadatta Maharaj/meditations with nisargadatta maharaj.pdf")
OUTPUT_PATH = Path("/Users/mijasmacbookpro/Desktop/Prof Cantay Research/Nisargadatta Maharaj/Meditations_with_Nisargadatta_Maharaj_cleaned.txt")

START_PAGE = 14  # PDF page number, 1-based

def normalize_whitespace(text):
    # turn tabs/nonbreaking spaces into normal spaces
    text = text.replace("\t", " ")
    text = text.replace("\u00A0", " ")
    text = text.replace("\u2002", " ")
    text = text.replace("\u2003", " ")
